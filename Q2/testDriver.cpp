...
//Test case 5: Appending a few elements: 1 2 3 4 5 6 to DataCollection 4 and then removing middle elements until Data Collection is empty
   cout << "Test Case 5 - Appending a few elements: 1 2 3 4 5 6 to DataCollection 4 and then removing middle elements until Data Collection is empty:" << endl;
   cout << "              expecting: 3 4 2 5 6 1 to be removed" << endl;
   for (unsigned int i = 1; i <= 6; i++) {
      try {
         cout << "Appending " << i << " to DataCollection 2" << endl;
         aDC4->append( i );
   ...
   cout << "Removing middle element " << aDC4->removeMiddle() << endl;
   cout << "Removing middle element " << aDC4->removeMiddle() << endl;
   cout << "Removing middle element " << aDC4->removeMiddle() << endl;
   cout << "Removing middle element " << aDC4->removeMiddle() << endl;
   cout << "Removing middle element " << aDC4->removeMiddle() << endl;
